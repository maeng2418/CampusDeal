...
class Container extends React.Component {
    ...
    render() {
        ...
        return (
            <SignUp onSubmit={this._onSubmit} onChange={this._onChange} campusList={campusList} privacy={privacy} service={service} marketing={marketing} isInvalid={isInvalid} error={error} handleError={this._handleError} handlePrivacy={this._handlePrivacy} handleMarketing={this._handleMarketing} handleService={this._handleService} />
                ...
                .then(dataAfterEmail => {
                    firebase.auth().onAuthStateChanged(
                        user => {
                            if (user) {
                                // Sign up successful
                                this.props.signup("Your account was successfully created! Now you need to verify your e-mail address, please go check your inbox.");
                            } else {
                                // Signup failed
